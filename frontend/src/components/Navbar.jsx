...
const Navbar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <nav className="sticky top-0 z-20 w-full h-16 bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 shadow-md flex items-center justify-between">
      {/* Left: Mobile Sidebar Toggle */}
      <button
        className="sm:hidden p-2 rounded-md bg-white border border-gray-300 shadow-sm focus:ring-2 focus:ring-teal-500 transition-transform hover:scale-105"
